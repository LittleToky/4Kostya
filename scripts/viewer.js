...
function conts(n){ // создает внутренности для конттаб, n указывает для какую именно 
	...
	if (n==4) {
		return lists.reduce(function(lilines,list,li){return (lilines+trStart('li'+li)+'<td>'+list.name+'</td><td colspan="4" class="center"><input type="button" value="+" onclick="lists['+li+'].units.push(new Unit); pageCreate(page);"></td><td>'+list.x+'</td><td>'+list.y+'</td></tr>'+list.units.reduce(function(unlines,unit,un){return(unlines+trStart('li'+li+'.'+un)+'<td></td>'+unitCells(li,un)+'<td colspan="2"></td></tr>')},''))},'');
	};
};
...
function features(obj){ // отображает таблицу характеристик
	...
	var feat=document.getElementById('feat'), tableStart='<table class="feattab"><tr><td>', inputTdStart='</td><td><input onchange="currentObject.name=this.value;  pageCreate(page);" type="text" value="';
	currentObject=obj;
	type=(obj.type);
	if (type=='Item') {feat.innerHTML=tableStart+'Деталь'+inputTdStart+obj.name+'" /></td></tr><tr><td>Отпускная цена</td><td><input onchange="currentObject.price=this.value;  pageCreate(page);" type="text" value="'+obj.price+'" /></td></tr><tr><td>Шифр</td><td><input onchange="currentObject.shifr=this.value; pageCreate(page);" type="text" value="'+obj.shifr+'" /></td></tr></table>'};
	if (type=='Route') {feat.innerHTML=tableStart+'Маршрут'+inputTdStart+obj.name+'" /></td></tr><tr><td>Себестоимость производства</td><td><input onchange="currentObject.price=this.value; pageCreate(page);" type="text" value="'+obj.price+'" /></tr></table>'};
	if (type=='Operation') {feat.innerHTML=tableStart+'Операция'+inputTdStart+obj.name+'" /></td></tr><tr><td>Длительность операции</td><td><input onchange="currentObject.dur=this.value; pageCreate(page);" type="text" value="'+obj.dur+'" /></tr><tr><td>Длительность переналадки</td><td><input onchange="currentObject.prepdur=this.value;  pageCreate(page);" type="text" value="'+obj.prepdur+'" /></tr><tr><td>Стоимость оснастки</td><td><input onchange="currentObject.price=this.value; pageCreate(page);" type="text" value="'+obj.price+'" /></tr><tr><td>Оборудование</td><td>'+maselect(obj.equip)+'</td></tr></table>'};
	if (type=='Machine') {feat.innerHTML=tableStart+'Станок'+inputTdStart+obj.name+'" /></td></tr><tr><td>Шифр</td><td><input onchange="currentObject.shifr=this.value; pageCreate(page);" type="text" value="'+obj.shifr+'" /></td></tr><tr><td>Стоимость</td><td><input onchange="currentObject.price=this.value; pageCreate(page);" type="text" value="'+obj.price+'" /></td></tr><tr><td>Стоимость обслуживания</td><td><input onchange="currentObject.servprice=this.value; pageCreate(page);" type="text" value="'+obj.servprice+'" /></td></tr><tr><td>Длина</td><td><input onchange="currentObject.x=this.value; pageCreate(page);" type="text" value="'+obj.x+'" /></td></tr><tr><td>Ширина</td><td><input onchange="currentObject.y=this.value; pageCreate(page);" type="text" value="'+obj.y+'" /></td></tr><tr><td>Имеется на производстве</td><td><input onchange="currentObject.have=this.value; pageCreate(page);" type="text" value="'+obj.have+'" /></td></tr></table>'};
	if (type=='Order') {feat.innerHTML=tableStart+'Заказ'+inputTdStart+obj.name+'" /></td></tr><tr><td>Число позиций</td><td>'+obj.positions.length+'</td></tr><tr><td>Бюджет</td><td><input onchange="currentObject.debet=this.value; pageCreate(page);" type="text" value="'+obj.debet+'" /></td></tr><tr><td>Желаемая прибыль</td><td><input onchange="currentObject.profw=this.value; pageCreate(page);" type="text" value="'+obj.profw+'" /></td></tr><tr><td>Стоимость заказа</td><td>'+obj.price+'</td></tr><tr><td>Срок выполнения</td><td><input onchange="currentObject.dur=this.value; pageCreate(page);" type="text" value="'+obj.dur+'" /></td></tr><tr><td>Оценить количество станков</td><td><input type="checkbox" '+((obj.mark)?'checked':'')+' onchange="currentObject.mark=this.checked; pageCreate(page)" /></td></tr></table>'};
	if (type=='Position') {feat.innerHTML=tableStart+'Позиция</td><td></td></tr><tr><td>Деталь</td><td>'+itselect(obj.it)+'</td></tr><tr><td>Размер партии</td><td><input onchange="currentObject.em=this.value; pageCreate(page);" type="text" value="'+obj.em+'" /></td></tr><tr><td>Можно исключить</td><td><input type="checkbox" '+((obj.exc)?'checked':'')+' onchange="currentObject.exc=this.checked; pageCreate(page)" /></td></tr></table>'};
	if (type=='List') {feat.innerHTML=tableStart+'Схема'+inputTdStart+obj.name+'" /></td></tr><tr><td>Число позиций</td><td>'+obj.units.length+'</td></tr><tr><td>Длина цеха</td><td><input onchange="currentObject.x=this.value; pageCreate(page);" type="text" value="'+obj.x+'" /></td></tr><tr><td>Ширина цеха</td><td><input onchange="currentObject.y=this.value; pageCreate(page);" type="text" value="'+obj.y+'" /></td></tr></table>'};
	if (type=='Unit') {feat.innerHTML=tableStart+'Ресурс</td><td></td></tr><tr><td>Станок</td><td>'+maselect(obj.equip)+'</td></tr><tr><td>Количество станков</td><td><input onchange="currentObject.count=this.value; pageCreate(page);" type="text" value="'+obj.count+'" /></td></tr></table>'};
}

function right (targ) { //(li&un added)
	var name=targ.attributes.name.value, type=defobj(name).type, indexes=name.slice(2).split('.'), trMoveUp='<tr><td onmousedown="move(-1)">Сдвинуть выше</td></tr>', trMoveDo='<tr><td onmousedown="move(1)">Сдвинуть ниже</td></tr>', trCopy='<tr><td onmousedown="copyJSON()">Копировать</td></tr>', tdPaste='push(JSON.parse(bufer.content));pageCreate(page);">';
	str='<table><tr><td onmousedown=';
	switch (type) {
		case 'Item':
			str+='"items.push(new Item);pageCreate(page);">Новая деталь</td></tr><tr><td onmousedown="items['+indexes[0]+'].routes.push(new Route);pageCreate(page);">Новый маршрут</td></tr>'+((indexes[0]!=0)?trMoveUp:'')+((indexes[0]!=items.length-1)?trMoveDo:'')+trCopy+((bufer!=undefined && bufer.type=='Item')?'<tr><td onmousedown="items.'+tdPaste+'Вставить деталь</td></tr>':'')+((bufer!=undefined && bufer.type=='Route')?'<tr><td onmousedown="items['+indexes[0]+'].routes.'+tdPaste+'Вставить маршрут</td></tr>':'');
		break;
		case 'Route':
			str+='"items['+indexes[0]+'].routes.push(new Route);pageCreate(page);">Новый маршрут</td></tr><tr><td onmousedown="items['+indexes[0]+'].routes['+indexes[1]+'].operations.push(new Operation);pageCreate(page);">Новая операция</td></tr>'+((indexes[1]!=0)?trMoveUp:'')+((indexes[1]!=items[indexes[0]].routes.length-1)?trMoveDo:'')+trCopy+((bufer!=undefined && bufer.type=='Route')?'<tr><td onmousedown="items['+indexes[0]+'].routes.'+tdPaste+'Вставить маршрут</td></tr>':'')+((bufer!=undefined && bufer.type=='Operation')?'<tr><td onmousedown="items['+indexes[0]+'].routes['+indexes[1]+'].operations.'+tdPaste+'Вставить операцию</td></tr>':'');
		break;
		case 'Operation':
			str+='"items['+indexes[0]+'].routes['+indexes[1]+'].operations.push(new Operation);pageCreate(page);">Новая операция</td></tr>'+((indexes[2]!=0)?trMoveUp:'')+((indexes[2]!=items[indexes[0]].routes[indexes[1]].operations.length-1)?trMoveDo:'')+trCopy+((bufer!=undefined && bufer.type=='Operation')?'<tr><td onmousedown="items['+indexes[0]+'].routes['+indexes[1]+'].operations.'+tdPaste+'Вставить операцию</td></tr>':'');
		break;
		case 'Machine':
			str+='"machines.push(new Machine);pageCreate(page);">Новый станок</td></tr>'+((indexes[0]!=0)?trMoveUp:'')+((indexes[0]!=machines.length-1)?trMoveDo:'')+trCopy+((bufer!=undefined && bufer.type=='Machine')?'<tr><td onmousedown="machines.'+tdPaste+'Вставить станок</td></tr>':'');
		break;
		case 'Order':
			str+='"orders.push(new Order);pageCreate(page);">Новый заказ</td></tr><tr><td onmousedown="orders['+indexes[0]+'].positions.push(new Position);pageCreate(page);">Новая позиция</td></tr>'+((indexes[0]!=0)?trMoveUp:'')+((indexes[0]!=orders.length-1)?trMoveDo:'')+trCopy+((bufer!=undefined && bufer.type=='Order')?'<tr><td onmousedown="orders.'+tdPaste+'Вставить заказ</td></tr>':'')+((bufer!=undefined && bufer.type=='Position')?'<tr><td onmousedown="orders['+indexes[0]+'].positions.'+tdPaste+'Вставить позицию</td></tr>':'');
		break;
		case 'Position':
			str+='"orders['+indexes[0]+'].positions.push(new Position);pageCreate(page);">Новая позиция</td></tr>'+((indexes[1]!=0)?trMoveUp:'')+((indexes[1]!=orders[indexes[0]].positions.length-1)?trMoveDo:'')+trCopy+((bufer!=undefined && bufer.type=='Position')?'<tr><td onmousedown="orders['+indexes[0]+'].positions.'+tdPaste+'Вставить позицию</td></tr>':'');
		break;
		case 'List':
			str+='"lists.push(new List);pageCreate(page);">Новая схема</td></tr><tr><td onmousedown="lists['+indexes[0]+'].units.push(new Unit);pageCreate(page);">Новый ресурс</td></tr>'+((indexes[0]!=0)?trMoveUp:'')+((indexes[0]!=lists.length-1)?trMoveDo:'')+'<tr><td onmousedown="copyJSON()">Копировать</td></tr><tr><td onmousedown="saveListJSON()">Сохранить</td></tr>'+((bufer!=undefined && bufer.type=='List')?'<tr><td onmousedown="lists.'+tdPaste+'Вставить схему</td></tr>':'')+((bufer!=undefined && bufer.type=='Unit')?'<tr><td onmousedown="lists['+indexes[0]+'].units.'+tdPaste+'Вставить ресурс</td></tr>':'');
		break;
		case 'Unit':
			str+='"lists['+indexes[0]+'].units.push(new Unit);pageCreate(page);">Новый ресурс</td></tr>'+((indexes[1]!=0)?trMoveUp:'')+((indexes[1]!=lists[indexes[0]].units.length-1)?trMoveDo:'')+trCopy+((bufer!=undefined && bufer.type=='Unit')?'<tr><td onmousedown="lists['+indexes[0]+'].units.'+tdPaste+'Вставить ресурс</td></tr>':'');
	}
...
function contsch(n) {
	var emptyTd='<td class="empty"></td>', listeners=' class="tile" onclick="selectline(this)" oncontextmenu="selectline(this); right(this)">';
	if (n==0) {
		return '<table class="contsch leftsch"><tr><td class="plus" colspan="3" onclick="items.push(new Item);pageCreate(page)">+</td><td colspan="2"></td></tr>'+items.reduce(function(itlines,item,it){return(itlines+'<tr><td colspan="3" name="it'+it+'"'+listeners+item.name+'</td><td class="plus" onclick="items['+it+'].routes.push(new Route);pageCreate(page)">+</td><td></td><td colspan="2"></td></tr>'+item.routes.reduce(function(rolines,route,ro){return(rolines+'<tr>'+emptyTd+'<td colspan="2" name="it'+it+'.'+ro+'"'+listeners+route.name+'</td><td class="plus" onclick="items['+it+'].routes['+ro+'].operations.push(new Operation);pageCreate(page)">+</td><td></td></tr>'+route.operations.reduce(function(oplines,operation,op){return(oplines+'<tr>'+emptyTd+emptyTd+'<td name="it'+it+'.'+ro+'.'+op+'"'+listeners+operation.name+'</td><td colspan="2"'+((operation.equip==='')?'>':' name="ma'+operation.equip+'"'+listeners+machines[operation.equip].name)+'</td></tr>')},''))},''))},'')+'</table>';
	};
	if (n==1) {
		return '<table class="contsch rightsch"><tr><td class="plus" onclick="machines.push(new Machine);pageCreate(page)">+</td><td colspan="2"></td></tr>'+machines.reduce(function(malines,machine,ma){return(malines+'<tr><td name="ma'+ma+'"'+listeners+machine.name+'</td></tr>')},'')+'</table>';
	};
	if (n==2) {
		return '<table class="contsch leftsch"><tr><td class="plus" colspan="2" onclick="orders.push(new Order);pageCreate(page)">+</td><td colspan="2"></td></tr>'+orders.reduce(function(orlines,order,or){return(orlines+'<tr><td colspan="2" name="or'+or+'"'+listeners+order.name+'</td><td class="plus" onclick="orders['+or+'].positions.push(new Position);pageCreate(page)">+</td><td></td></tr>'+order.positions.reduce(function(polines,position,po){return(polines+'<tr>'+emptyTd+'<td name="or'+or+'.'+po+'"'+listeners+'Позиция №'+(po*1+1).toString()+'</td><td colspan="2"'+((position.it==='')?'>':' name="it'+position.it+'"'+listeners+items[position.it].name)+'</td></tr>')},''))},'')+'</table>';
	};
	if (n==3) {
		return '<table class="contsch rightsch"><tr><td class="plus" onclick="items.push(new Item);pageCreate(page)">+</td><td colspan="2"></td></tr>'+items.reduce(function(itlines,item,it){return(itlines+'<tr><td name="it'+it+'"'+listeners+item.name+'</td></tr>')},'')+'</table>'
	};
	if (n==4) {
		return '<table class="contsch leftsch"><tr><td class="plus" colspan="2" onclick="lists.push(new List);pageCreate(page)">+</td><td colspan="2"></td></tr>'+lists.reduce(function(lilines,list,li){return(lilines+'<tr><td colspan="2" name="li'+li+'"'+listeners+list.name+'</td><td class="plus" onclick="lists['+li+'].units.push(new Unit);pageCreate(page)">+</td><td></td></tr>'+list.units.reduce(function(unlines,unit,un){return(unlines+'<tr>'+emptyTd+'<td name="li'+li+'.'+un+'"'+listeners+'Ресурс №'+(un*1+1).toString()+'</td><td colspan="2"'+((unit.equip==='')?'>':' name="ma'+unit.equip+'"'+listeners+machines[unit.equip].name)+'<td></td></tr>')},''))},'')+'</table>'
	};
}
